...
psql -f "${MIGRATION_DIR}/006_production_bottleneck_indexes.sql"
psql -f "${MIGRATION_DIR}/007_backfill_barrier_outcomes.sql"
...
psql -f "${MIGRATION_DIR}/013_ingestion_runtime_integrity.sql"
psql -f "${MIGRATION_DIR}/014_stable_tab_horse_identity.sql"
