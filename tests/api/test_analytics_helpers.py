...
def test_compute_person_metrics_calculates_rates_and_roi():
    rows = [
        {"person": "A Trainer", "split_value": None, "final_position": 1, "closing_price": 3.5},
        {"person": "A Trainer", "split_value": None, "final_position": 2, "closing_price": 5.0},
        {"person": "A Trainer", "split_value": None, "final_position": 5, "closing_price": 4.0},
        {"person": "B Trainer", "split_value": None, "final_position": 1, "closing_price": None},
    ]
